...
public final class GlobalNotificationBuilder {
    ...
    private NotificationCompat.Builder sGlobalNotificationCompatBuilder = null;
    ...
    public void setNotificationCompatBuilderInstance (NotificationCompat.Builder builder) {
        sGlobalNotificationCompatBuilder = builder;
    }

    public NotificationCompat.Builder getNotificationCompatBuilderInstance() {
